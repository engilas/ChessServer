...
namespace ilf.pgn.Data.Format
{
    ...
    class MoveFormatter
    {
        ...
        public void Format(IlfMove move, TextWriter writer)
        {
            var handled =
        ...
        public string Format(IlfMove move)
        {
        ...
        private bool HandleCapturingMove(IlfMove move, TextWriter writer)
        {
        ...
        private bool HandleSimpleMove(IlfMove move, TextWriter writer)
        {
        ...
        /// <param name="writer">The writer.</param>
        /// <returns></returns>
        private bool HandleCastle(IlfMove move, TextWriter writer)
        {
            switch (move.Type)
            {
        ...
        private string GetMoveTarget(IlfMove move)
        {
            var piece = "";
        ...
        private string GetMoveOrigin(IlfMove move)
        {
        ...
        private string GetCheckAndMateAnnotation(IlfMove move)
        {
        ...
        private string GetAnnotation(IlfMove move)
        {
